# Install and Test Stage Bridge Beta 5
...
2. Under **Assets**, download `stage-bridge-0.1.0-beta.5.rbz`.
...
4. Find the downloaded `stage-bridge-0.1.0-beta.5.rbz`, select it, and click **Open**.
...
## What to Check in Beta 5

- The stock SketchUp human is gone.
- Full-size steel poppers match the leftmost popper from the Big Prop row.
- White-center vertical stacks use the selected no-shoot assembly.
