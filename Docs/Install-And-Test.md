# Install and Test Stage Bridge Beta 7
...
2. Under **Assets**, download `stage-bridge-0.1.0-beta.7.rbz`.
...
4. Find the downloaded `stage-bridge-0.1.0-beta.7.rbz`, select it, and click **Open**.
...
## What to Check in Beta 7

- The four Stage Bridge toolbar buttons use distinct icons for Import Stage, Add Prop, Validate Stage, and Export Stage.
